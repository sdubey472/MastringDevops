...
if you have multiple machine like Machine1 and Machine2 and using ssh in linux can communicate between machines. talnet is another option but it's not more secure because its share your crediential in plain text and it's perfer for local enviorment.

and in Ssh all the username and password is saved in encrypted. ssh saved remote machine Mac address and other details in encrypted. 
